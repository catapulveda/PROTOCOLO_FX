...
public class TotallingTableView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        table.getColumns().add(column("Item", Item::nameProperty, new DefaultStringConverter()));

        table.getColumns().add(column("Value", Item::valueProperty, new NumberStringConverter()));
        ...
        add.setOnAction(e -> table.getItems().add(new Item("New Item", table.getItems().size() + 1)));
    ...
    private <S,T> TableColumn<S,T> column(String title, Function<S, ObservableValue<T>> property, StringConverter<T> converter) {
