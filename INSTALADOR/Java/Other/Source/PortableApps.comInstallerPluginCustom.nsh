...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_181\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_181\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_181\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_181\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_181\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_181\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_181\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_181\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_181\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_181"
